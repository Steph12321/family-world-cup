...
const DATA = {
  ...
  matches: [
    ...
    // MD3
    { id: "gs_d5", stage: "Group D", homeTeam: "tur", awayTeam: "usa", kickoffUTC: "2026-06-26T02:00:00Z", homeScore: 3, awayScore: 2, status: "finished" },
    { id: "gs_d6", stage: "Group D", homeTeam: "par", awayTeam: "aus", kickoffUTC: "2026-06-26T02:00:00Z", homeScore: 0, awayScore: 0, status: "finished" },
    ...
    // MD3
    { id: "gs_e5", stage: "Group E", homeTeam: "ecu", awayTeam: "ger", kickoffUTC: "2026-06-25T20:00:00Z", homeScore: 2, awayScore: 1, status: "finished" },
    { id: "gs_e6", stage: "Group E", homeTeam: "cuw", awayTeam: "civ", kickoffUTC: "2026-06-25T20:00:00Z", homeScore: 0, awayScore: 2, status: "finished" },
    ...
    // MD3
    { id: "gs_f5", stage: "Group F", homeTeam: "jpn", awayTeam: "swe", kickoffUTC: "2026-06-25T23:00:00Z", homeScore: 1, awayScore: 1, status: "finished" },
    { id: "gs_f6", stage: "Group F", homeTeam: "tun", awayTeam: "ned", kickoffUTC: "2026-06-25T23:00:00Z", homeScore: 1, awayScore: 3, status: "finished" },
    ...
    { id: "r32_02", stage: "Round of 32", homeTeam: "bra", awayTeam: "jpn", kickoffUTC: "2026-06-29T17:00:00Z", homeScore: 2, awayScore: 1, status: "finished" },
    { id: "r32_03", stage: "Round of 32", homeTeam: "ned", awayTeam: "mar", kickoffUTC: "2026-06-30T01:00:00Z", homeScore: 1, awayScore: 1, status: "finished" },
    { id: "r32_05", stage: "Round of 32", homeTeam: "civ", awayTeam: "nor", kickoffUTC: "2026-06-30T17:00:00Z", homeScore: 1, awayScore: 2, status: "finished" },
    { id: "r32_04", stage: "Round of 32", homeTeam: "usa", awayTeam: "bih", kickoffUTC: "2026-07-02T00:00:00Z", homeScore: 2, awayScore: 0, status: "finished" },
    { id: "r32_06", stage: "Round of 32", homeTeam: "ger", awayTeam: "par", kickoffUTC: "2026-06-29T20:30:00Z", homeScore: 1, awayScore: 1, status: "finished" },
    { id: "r32_07", stage: "Round of 32", homeTeam: "fra", awayTeam: "swe", kickoffUTC: "2026-06-30T21:00:00Z", homeScore: 3, awayScore: 0, status: "finished" },
    { id: "r32_08", stage: "Round of 32", homeTeam: "mex", awayTeam: "ecu", kickoffUTC: "2026-07-01T01:00:00Z", homeScore: 2, awayScore: 0, status: "finished" },
    { id: "r32_09", stage: "Round of 32", homeTeam: "eng", awayTeam: "cod", kickoffUTC: "2026-07-01T21:00:00Z", homeScore: 2, awayScore: 1, status: "finished" },
    { id: "r32_10", stage: "Round of 32", homeTeam: "bel", awayTeam: "sen", kickoffUTC: "2026-07-01T20:00:00Z", homeScore: 3, awayScore: 2, status: "finished" },
    ...
    { id: "r32_15", stage: "Round of 32", homeTeam: "arg", awayTeam: "cpv", kickoffUTC: "2026-07-03T22:00:00Z", homeScore: 3, awayScore: 2, status: "finished" },
    { id: "r32_16", stage: "Round of 32", homeTeam: "col", awayTeam: "gha", kickoffUTC: "2026-07-04T01:30:00Z", homeScore: 1, awayScore: 0, status: "finished" },
    ...
    { id: "r16_08", stage: "Round of 16", homeTeam: "sui", awayTeam: "col", kickoffUTC: "2026-07-07T20:00:00Z", homeScore: 0, awayScore: 0, status: "finished" },

    // ── Quarter-finals ───────────────────────────────────────
    { id: "qf_01", stage: "Quarter-finals", homeTeam: "mar", awayTeam: "fra", kickoffUTC: "2026-07-09T20:00:00Z", homeScore: 0, awayScore: 2, status: "finished" },
    { id: "qf_02", stage: "Quarter-finals", homeTeam: "esp", awayTeam: "bel", kickoffUTC: "2026-07-10T19:00:00Z", homeScore: 0, awayScore: 2, status: "finished" },
    ...
    { id: "qf_04", stage: "Quarter-finals", homeTeam: "arg", awayTeam: "sui", kickoffUTC: "2026-07-12T01:00:00Z", homeScore: null, awayScore: null, status: "scheduled" },

    // ── Semi-finals ──────────────────────────────────────────────
    { id: "sf_01", stage: "Semi-finals", homeTeam: "fra", awayTeam: "bel", kickoffUTC: "2026-07-14T19:00:00Z", homeScore: null, awayScore: null, status: "scheduled" }

  ],

  // Manual override: add team IDs here to mark them eliminated
  // regardless of match data (e.g. after group stage is complete)
  eliminated: ["cze", "qat", "hai", "tur", "cuw", "tun", "ksa", "irq", "jor", "nzl", "sco", "uru", "pan", "uzb", "kor", "irn", "rsa", "jpn", "ger", "ned", "civ", "swe", "ecu", "cod", "bih", "sen", "aut", "cro", "alg", "aus", "cpv", "gha", "can", "par", "bra", "mex", "por", "usa", "egy", "col", "mar", "esp"]
};
